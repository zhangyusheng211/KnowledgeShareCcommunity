...
//        registry.addResourceHandler("/app/**").addResourceLocations("classpath:/resources/");
//        registry.addResourceHandler("/assets/**").addResourceLocations("classpath:/resources/");
//        registry.addResourceHandler("/dist/**").addResourceLocations("classpath:/resources/");
//        registry.addResourceHandler("/lib/**").addResourceLocations("classpath:/resources/");
//        registry.addResourceHandler("/static/**").addResourceLocations("classpath:/resources/");
//        registry.addResourceHandler("/index.htm").addResourceLocations("classpath:/resources/");
    }
