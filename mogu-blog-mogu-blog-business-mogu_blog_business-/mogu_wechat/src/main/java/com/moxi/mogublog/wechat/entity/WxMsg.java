package com.moxi.mogublog.wechat.entity;
...
public class WxMsg implements Serializable {
    ...
    public WxMsg(WxMpXmlMessage wxMessage) {
        ...
        this.detail = JsonUtils.objectToJson(detail);
    }

    public static WxMsg buildOutMsg(String msgType, String openid, Object detail) {
        WxMsg wxMsg = new WxMsg();
        wxMsg.appid = WxMpConfigStorageHolder.get();
        wxMsg.msgType = msgType;
        wxMsg.openid = openid;
        wxMsg.detail = JsonUtils.objectToJson(detail);
