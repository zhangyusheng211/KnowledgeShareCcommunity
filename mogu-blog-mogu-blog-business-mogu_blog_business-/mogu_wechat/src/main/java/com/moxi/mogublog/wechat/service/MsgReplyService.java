...
public interface MsgReplyService {
     ...
     * @return 匹配的
     */
    String tryAutoReplyText(String appid, boolean exactMatch, String toUser, String keywords);
     ...
     * @return 匹配的
     */
    String eventReplyText(String openId, String content);
     ...
     * @return
     */
    String chatGPTReplayText(String openID, String keywords);
