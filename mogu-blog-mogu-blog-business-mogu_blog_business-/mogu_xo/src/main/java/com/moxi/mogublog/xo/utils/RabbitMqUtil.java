...
public class RabbitMqUtil {
    ...
    public void sendActivateEmail(User user, String token) {
        String text =
                "<html>\r\n" +
                        ...
                        "<p>地址：" + "<a href=\"" + dataWebUrl + "/auth/activeUser/" + token + "\">点击这里</a>" + "</p>\r\n" +
                        "\r\n" +
                        "</div>\r\n" +
                        "</div>\r\n" +
                        "<div class=\"footer\">\r\n" +
     ...
     * @param token
     */
    public void sendForgetPasswordEmail(Admin admin, String token) {
        String text =
                "<html>\r\n" +
                        " <head>\r\n" +
                        "  <title>" + PROJECT_NAME + "</title>\r\n" +
                        ...
                        "</div>\r\n" +
                        "<div class=\"panel-body\">\r\n" +
                        "<p>您好 <a href=\"mailto:" + admin.getEmail() + "\" rel=\"noopener\" target=\"_blank\">" + admin.getNickName() + "<wbr></a>！</p>\r\n" +
                        "<p>欢迎您使用" + PROJECT_NAME + "账号，请点击下方链接进行新密码激活</p>\r\n" +
                        "<p>地址：" + "<a href=\"" + dataWebUrl + "/auth/activePassword/" + token + "\">点击这里</a>" + "</p>\r\n" +
                        "\r\n" +
                        "</div>\r\n" +
                        "</div>\r\n" +
                        "<div class=\"footer\">\r\n" +
