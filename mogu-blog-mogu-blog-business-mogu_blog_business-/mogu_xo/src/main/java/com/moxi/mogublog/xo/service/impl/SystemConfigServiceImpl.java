...
import com.moxi.mogublog.commons.vo.SystemConfigVO;
...
public class SystemConfigServiceImpl extends SuperServiceImpl<SystemConfigMapper, SystemConfig> implements SystemConfigService {
    ...
    public String editSystemConfig(SystemConfigVO systemConfigVO) {
        // 图片必须选择上传到一个区域
        if (EOpenStatus.CLOSE.equals(systemConfigVO.getUploadLocal()) && EOpenStatus.CLOSE.equals(systemConfigVO.getUploadQiNiu()) && EOpenStatus.CLOSE.equals(systemConfigVO.getUploadMinio()) && EOpenStatus.CLOSE.equals(systemConfigVO.getUploadAlioss())) {
        ...
        if ((EFilePriority.ALIOSS.equals(systemConfigVO.getPicturePriority())
                || EFilePriority.ALIOSS.equals(systemConfigVO.getContentPicturePriority()))
                && EOpenStatus.CLOSE.equals(systemConfigVO.getUploadAlioss())) {
