...
import com.moxi.mogublog.commons.vo.CategoryMenuVO;
...
public class CategoryMenuRestApi {
    ...
    @ApiOperation(value = "获取某个用户允许访问的菜单列表", notes = "获取某个用户允许访问的菜单列表", response = String.class)
    @RequestMapping(value = "/getCategoryMenuByUserName", method = RequestMethod.GET)
    public String getCategoryMenuByUserName(@RequestParam(value = "userName", required = false) String userName) {
        return ResultUtil.successWithData(categoryMenuService.getCategoryMenuByUserName(userName));
    }
