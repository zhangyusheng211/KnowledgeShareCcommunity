...
public class CommentRestApi {
    ...
    @AuthorityVerify
    @OperationLogger(value = "审核评论")
    @ApiOperation(value = "审核评论", notes = "审核评论", response = String.class)
    @PostMapping("/audit")
    public String audit(@RequestBody CommentVO commentVO) {
        return commentService.auditComment(commentVO);
    }
