...
public class SysLogHandle extends AbstractRequestAwareRunnable {
     ...
     * @param bizType
     */
    public SysLogHandle(String userUid, String ip, String os, String browser, String behavior, String moduleUid, String otherData, RedisUtil redisUtil, String bizType) {
