  ...
  <div class="app-container">
      <!-- 查询和其他操作 -->
	    <div class="filter-container" style="margin: 10px 0 10px 0;">
				<el-input clearable class="filter-item" style="width: 200px;" size="small" v-model="queryParams.userName" placeholder="请输入操作人"></el-input>
        <el-input clearable class="filter-item" style="width: 200px;" size="small" v-model="queryParams.operation" placeholder="请输入接口名"></el-input>
        <el-input clearable class="filter-item" style="width: 200px;" size="small" v-model="queryParams.ip" placeholder="请输入IP"></el-input>

        <el-select v-model="queryParams.spendTime" placeholder="请求耗时" size="small" style="width:150px"  clearable>
          <el-option
        ...
        <el-date-picker
	      ...
	      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFind" size="small" v-permission="'/log/getLogList'">查找</el-button>
	    </div>
