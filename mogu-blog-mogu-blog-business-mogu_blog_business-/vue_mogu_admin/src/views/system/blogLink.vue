<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;" v-permission="'/link/getList'">
      ...
      <el-select v-model="linkStatusKeyword" clearable placeholder="友链状态" style="width:140px" size="small">
        <el-option
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFind" size="small" v-permission="'/link/getList'">查找</el-button>
      <el-button class="filter-item" type="primary" @click="handleAdd" icon="el-icon-edit" size="small" v-permission="'/link/add'">添加友链</el-button>
    </div>
...
<!--      </el-table-column>-->
      ...
      <el-table-column label="操作" fixed="right" min-width="240">
        <template slot-scope="scope">
          <el-button @click="handleStick(scope.row)" type="warning" size="mini" v-permission="'/link/stick'">置顶</el-button>
          <el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/link/edit'">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/link/delete'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
