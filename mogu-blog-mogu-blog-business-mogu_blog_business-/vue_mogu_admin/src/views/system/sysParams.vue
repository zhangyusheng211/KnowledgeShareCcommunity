<template>
    <div class="app-container">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="参数键值" width="400" align="center">
                <template slot-scope="scope">
                    <span>{{ splitString(scope.row.paramsValue, 100) }}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="dialogFormVisible">
            <el-form :model="form" :rules="rules" ref="form">
                ...
                <el-form-item label="参数键值" :label-width="formLabelWidth" prop="paramsValue">
                    <el-input type="textarea" :rows="2" v-model="form.paramsValue" auto-complete="off"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        splitString(str, maxLength) {
            return this.$commonUtil.splitString(str, maxLength)
        },
        /**
         * 字典查询
         */
        getDictList: function () {
            ...
            let dictTypeList = ['sys_params_type']
