...
<div id="table" class="app-container calendar-list-container">
	    ...
	    <div class="filter-container" style="margin: 10px 0 10px 0;">
	      ...
	      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFind" size="small" v-permission="'/resourceSort/getList'">查找</el-button>
	      <el-button class="filter-item" type="primary" @click="handleAdd" icon="el-icon-edit" size="small" v-permission="'/resourceSort/add'">添加</el-button>
        <el-button class="filter-item" type="danger" @click="handleDeleteBatch" icon="el-icon-delete" size="small" v-permission="'/resourceSort/deleteBatch'">删除选中</el-button>
	    </div>
    ...
    <el-table :data="tableData"  style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="排序" width="100" align="center">
	    ...
	    <el-table-column label="操作" fixed="right" min-width="220">
	      <template slot-scope="scope" >
          <el-button @click="handleStick(scope.row)" type="warning" size="mini" v-permission="'/resourceSort/stick'">置顶</el-button>
	      	<el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/resourceSort/edit'">编辑</el-button>
	        <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/resourceSort/delete'">删除</el-button>
	      </template>
	    </el-table-column>
	  </el-table>
