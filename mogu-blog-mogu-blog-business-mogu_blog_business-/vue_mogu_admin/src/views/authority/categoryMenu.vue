<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      <el-button class="filter-item" type="primary" @click="handleAdd" icon="el-icon-edit" size="small" v-permission="'/categoryMenu/add'">添加菜单</el-button>
    </div>
          ...
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-table :data="scope.row.childCategoryMenu" :show-header="showHeader" style="width: 100%">
              ...
              <el-table-column fixed="right" min-width="230">
                <template slot-scope="scope_child">
                  <el-button @click="handleStick(scope_child.row)" type="warning" size="mini" v-permission="'/categoryMenu/stick'">置顶</el-button>
                  <el-button @click="handleEdit(scope_child.row)" type="primary" size="mini" v-permission="'/categoryMenu/edit'">编辑</el-button>
                  <el-button @click="handleDelete(scope_child.row)" type="danger" size="mini" v-permission="'/categoryMenu/delete'">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-form>
