  ...
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      <el-input
        ...
        size="small"
      ></el-input>
      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFind" size="small" v-permission="'/admin/getList'">查找</el-button>
      <el-button class="filter-item" type="primary" @click="handleAdd" icon="el-icon-edit" size="small" v-permission="'/admin/add'">添加</el-button>
    </div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" fixed="right" min-width="250" >
        <template slot-scope="scope">
          <el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/admin/edit'">编辑</el-button>
          <el-button @click="handRest(scope.row)" type="warning" size="mini" v-permission="'/admin/restPwd'">重置密码</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/admin/delete'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
            ...
            <el-form-item :label-width="formLabelWidth">
              ...
              <template slot="label">
                ...
                <el-popover
                  ...
                  width="200"
                  trigger="hover"
                  content="管理员可以选择绑定门户的用户，后续在管理端的文章和问答操作将以该用户的名义完成发布">
              ...
              <el-select
                ...
                remote
                reserve-keyword
                placeholder="查询要附身的用户名"
                :remote-method="querySearchUserAsync"
                :loading="loading">
                <el-option
...
export default {
  ...
  methods: {
    querySearchUserAsync: function (keyword) {
      ...
      getAdminList(params).then(response => {
        if(response.code == this.$ECode.SUCCESS) {
          ...
          for(let a=0; a< tableData.length; a++) {
            ...
            if (tableData[a].user) {
              userList.push(tableData[a].user)
            }
          }
