      ...
      <el-table-column :width="operaColumnWidth">
        ...
        <template slot-scope="scope">
          <div v-if="operaColumnExpand">
            ...
            <el-button v-if="scope.row.isDir === 0"  type="primary" size="mini"  @click.native="copyFileDialog(scope.row)">复制</el-button>
          ...
          <el-dropdown v-else trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item v-if="scope.row.isDir === 0"  type="primary" size="mini"  @click.native="copyFileDialog(scope.row)">复制</el-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    showMoveFileDialog(file) {
      ...
      copyFileDialog(file) {
          this.$commonUtil.copyText(file.fileUrl)
