...
<script>
import {materialArticleUpdate, msgTemplateManageInfo, insertOrUpdateMsgReply} from "../../api/wechat";
        ...
        init(id) {
            ...
            this.$nextTick(() => {
                ...
                if (this.dataForm.id) {
                    ...
                    msgTemplateManageInfo(this.dataForm.id).then(data=> {
        ...
        dataFormSubmit() {
            this.$refs['dataForm'].validate((valid) => {
                if (valid) {
                    ...
                    insertOrUpdateMsgReply(!this.dataForm.id ? 'save' : 'update', this.dataForm).then(data=> {
                        if (data && data.code === this.$ECode.SUCCESS) {
                            this.$message({
                                message: '操作成功',
                                type: 'success',
