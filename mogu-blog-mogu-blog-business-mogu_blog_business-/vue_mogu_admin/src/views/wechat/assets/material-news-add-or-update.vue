...
<script>
import {materialNewsUpload, materialArticleUpdate} from "../../../api/wechat";
...
export default {
    components: {
        TinymceEditor: () => import('@/components/Wechat/tinymce-editor'),
    ...
    methods: {
        ...
        materialNewsUpload(){
            ...
            materialNewsUpload(this.articles).then(data=> {
        ...
        materialArticleUpdate(){
            ...
            materialArticleUpdate(params).then(data=> {
                if (data && data.code === this.$ECode.SUCCESS) {
                    this.$message({
                        message: "操作成功",
                        type: "success",
