<template>
    <div class="mod-config" style="margin: 10px">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            <el-form-item>
                <el-input size="small" v-model="dataForm.sceneStr" placeholder="场景值" clearable></el-input>
            </el-form-item>
            <el-form-item>
...
import {deleteWxQrCode, getWxQrCodeList} from "../../api/wechat";
export default {
    data() {
        return {
            dataForm: {
    ...
    methods: {
        ...
        getDataList() {
            ...
            params.sceneStr = this.dataForm.sceneStr
            params.sidx = 'id'
            params.order = 'desc'
            getWxQrCodeList().then(data => {
