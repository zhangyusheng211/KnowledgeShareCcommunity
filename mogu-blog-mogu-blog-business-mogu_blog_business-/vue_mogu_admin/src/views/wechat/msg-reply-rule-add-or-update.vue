...
import {getWxMsgReplyRuleInfo, insertOrUpdateMsgReplyRule} from "../../api/wechat";
export default {
    components: {
        tagsEditor: () => import('@/components/Wechat/tags-editor'),
        ...
        init(id) {
            ...
            this.$nextTick(() => {
                ...
                if (this.dataForm.ruleId) {
                    ...
                    getWxMsgReplyRuleInfo(this.dataForm.ruleId).then(data => {
        ...
        dataFormSubmit() {
            this.$refs["dataForm"].validate(valid => {
                if (valid) {
                    ...
                    insertOrUpdateMsgReplyRule(!this.dataForm.ruleId ? "save" : "update", this.dataForm).then(data=> {
                        if (data && data.code === this.$ECode.SUCCESS) {
                            this.$message({
                                message: "操作成功",
                                type: "success",
