...
import {deleteWxAccount, getWxAccountList} from "../../api/wechat";
export default {
    data() {
        return {
            dataForm: {
    ...
    methods: {
        ...
        getDataList() {
            ...
            this.dataListLoading = true
              getWxAccountList().then(data => {
              if (data.code === this.$ECode.SUCCESS) {
