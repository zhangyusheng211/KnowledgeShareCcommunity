<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      ...
      <el-select v-model="feedbackStatusKeyword" clearable placeholder="反馈状态" size="small" style="width:140px">
        <el-option
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFind" size="small" v-permission="'/feedback/getList'">查找</el-button>
      <el-button class="filter-item" type="danger" @click="handleDeleteBatch" icon="el-icon-delete" size="small" v-permission="'/feedback/deleteBatch'">删除选中</el-button>
    </div>
    ...
    <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" fixed="right" min-width="240">
        <template slot-scope="scope">
          <el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/feedback/edit'">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/feedback/deleteBatch'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
