  ...
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;" v-permission="'/blogSort/getList'">
      <el-input
        ...
        placeholder="请输入分类名"
      ></el-input>
      <el-button class="filter-item" type="primary" size="small" icon="el-icon-search" @click="handleFind" v-permission="'/blogSort/getList'">查找</el-button>
      <el-button class="filter-item" type="primary" size="small" @click="handleAdd" icon="el-icon-edit" v-permission="'/blogSort/add'">添加分类</el-button>
      <el-button class="filter-item" type="danger" size="small" @click="handleDeleteBatch" icon="el-icon-delete" v-permission="'/blogSort/deleteBatch'">删除选中</el-button>
      <el-button
        class="filter-item"
        type="info"
    ...
    <el-table :data="tableData"
      ...
      <el-table-column label="操作" fixed="right" min-width="230">
        <template slot-scope="scope">
          <el-button @click="handleStick(scope.row)" type="warning" size="mini" v-permission="'/blogSort/stick'">置顶</el-button>
          <el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/blogSort/edit'">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/blogSort/delete'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
