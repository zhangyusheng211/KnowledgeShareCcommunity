  ...
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;" v-permission="'/tag/getList'">
      <el-input
        ...
        size="small"
      ></el-input>
      <el-button class="filter-item" type="primary" size="small" icon="el-icon-search" @click="handleFind" v-permission="'/tag/getList'">查找</el-button>
      <el-button class="filter-item" type="primary" size="small" @click="handleAdd" icon="el-icon-edit" v-permission="'/tag/add'">添加标签</el-button>
      <el-button class="filter-item" type="danger" size="small" @click="handleDeleteBatch" icon="el-icon-delete" v-permission="'/tag/deleteBatch'">删除选中</el-button>
      <el-button
        class="filter-item"
        type="info"
    ...
    <el-table :data="tableData"
      ...
      <el-table-column label="操作" fixed="right" min-width="230">
        <template slot-scope="scope">
          <el-button @click="handleStick(scope.row)" type="warning" size="mini" v-permission="'/tag/stick'">置顶</el-button>
          <el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/tag/edit'">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/tag/delete'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
