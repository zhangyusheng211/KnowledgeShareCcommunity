...
<div id="table" class="app-container calendar-list-container">
	    ...
	    <div class="filter-container" style="margin: 10px 0 10px 0;">
	      <el-input clearable class="filter-item" style="width: 200px;" v-model="keyword" size="small" placeholder="请输入分类名称"></el-input>
	      <el-button class="filter-item" type="primary" icon="el-icon-search" size="small" @click="handleFind" v-permission="'/pictureSort/getList'">查找</el-button>
	      <el-button class="filter-item" type="primary" @click="handleAdd" size="small" icon="el-icon-edit" v-permission="'/pictureSort/add'">添加</el-button>
	    </div>
    ...
    <el-table :data="tableData"  style="width: 100%">
      ...
      <el-table-column label="序号" width="60" align="center">
	      ...
	      <template slot-scope="scope">
	      	<el-image  v-if="scope.row.photoList" :src="scope.row.photoList[0]" :preview-src-list="scope.row.photoList" style="width: 93px;height: 50px;" ></el-image>
	      </template>
	    </el-table-column>
      ...
      <el-table-column label="更新时间" width="160" align="center">
	    ...
	    <el-table-column label="操作" fixed="right" min-width="315">
	      <template slot-scope="scope" >
          <el-button @click="handleManager(scope.row)" type="success" size="mini">图片列表</el-button>
          <el-button @click="handleStick(scope.row)" type="warning" size="mini" v-permission="'/pictureSort/stick'">置顶</el-button>
	      	<el-button @click="handleEdit(scope.row)" type="primary" size="mini" v-permission="'/pictureSort/edit'">编辑</el-button>
	        <el-button @click="handleDelete(scope.row)" type="danger" size="mini" v-permission="'/pictureSort/delete'">删除</el-button>
	      </template>
	    </el-table-column>
	  </el-table>
