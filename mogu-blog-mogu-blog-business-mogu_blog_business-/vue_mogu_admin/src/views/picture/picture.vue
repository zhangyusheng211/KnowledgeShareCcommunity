...
<div id="table" class="app-container calendar-list-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      <el-button class="filter-item" type="primary" @click="handleAdd" icon="el-icon-edit" size="small" v-permission="'/picture/add'">添加</el-button>
<!--      <el-button class="filter-item" type="primary" @click="handleReturn" icon="el-icon-s-promotion">返回分类</el-button>-->
      <el-button class= "button" type="primary"  @click="checkAll()" size="small" icon="el-icon-refresh">{{chooseTitle}}</el-button>
      <el-button class="filter-item" type="danger" @click="handleDeleteBatch" size="small" icon="el-icon-delete" v-permission="'/picture/delete'">删除选中</el-button>
      <el-button class="filter-item" type="success" @click="setCover" size="small" icon="el-icon-video-camera-solid" v-permission="'/picture/setCover'">设为封面</el-button>
    </div>
            ...
            <div style="margin-bottom: 14px;">
              <el-button-group>
                ...
                <el-tooltip class="item" effect="dark" content="裁剪图片" placement="bottom-start" style="margin-right: 2px" v-permission="'/picture/add'">
                  ...
                  <el-tooltip class="item" effect="dark" content="复制图片UID" placement="bottom-start" style="margin-right: 2px">
                      <el-button
                          type="info"
                          size="mini"
                          icon="el-icon-copy-document"
