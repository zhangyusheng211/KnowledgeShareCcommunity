<template>
    <div class="app-container">
        ...
        <el-table :data="tableData"
            ...
            <el-table-column label="排序" width="90" align="center" prop="clickCount" sortable="custom"
                             :sort-by="['clickCount']">
                <template slot-scope="scope">
                    ...
                    <el-col :span="4.5">
                        <el-form-item label="是否发布" :label-width="lineLabelWidth" prop="isPublish">
                            <el-radio-group v-model="form.isPublish" size="small">
                                <el-radio v-for="item in questionTemplatePublishDictList" :key="item.uid"
