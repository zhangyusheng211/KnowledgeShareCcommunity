...
public class BaseMessageConf {
    ...
    public static final String SUBMIT_SUCCESS_AUDIT = "提交成功，等待管理员审核通过后显示";
    ...
    public static final String PLEASE_SET_ALIOSS = "请先配置阿里OSS文件上传服务";
    ...
    public static final String LOGIN_AUTH = "账号未登录";
    ...
    public static final String BLOG_IS_DELETE = "该资源已下架或被删除！";
    public static final String PROBLEM_IS_DELETE = "该问题已下架或被删除！";
    ...
    public final static String PRISE_SUCCESS = "点赞成功!";
    public final static String PRISE_CANCEL = "取消成功!";
    public final static String TREAD_SUCCESS = "点踩成功!";
    public final static String TREAD_CANCEL = "取消成功!";
    public final static String YOU_HAVE_BEEN_PRISE = "您已经点过赞/踩啦!";
    public final static String YOU_HAVE_BEEN_TREADE = "您已经点过赞/踩啦!";
    ...
    public final static String MUST_BE_OPEN_ALIOSS_UPLOAD = "图片显示优先级为阿里oss对象存储，必须开启图片上传阿里oss对象存储";
    ...
    public static final String REGULAR_FAIL = "请勿提交无效内容";
    public static final String REGULAR_PARAM_NULL = "未找到参数";
    public static final String BLOG_VIP_FORBIDDEN = "当前文章为特权文章，无法查看";
    public static final String BLOG_VIP_LOGIN = "当前文章为特权文章，请先登录";

    public static final String USER_ACCOUNT_EXIST = "该账号已经被用户绑定，请先联系管理员完成账号解绑";

    public static final String USER_ACCOUNT_REPETITION = "当前账号已经绑定该用户，无需重复绑定";

    public static final String USER_ACTIVE = "用户账号已经被激活";
    ...
    public static final String NOT_SET_ADMIN_USER_UID = "您暂未附身门户用户无法进行操作，请到 管理员管理-> 编辑, 选择要附身用户 再重新操作";
