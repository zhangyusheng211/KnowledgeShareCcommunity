...
public class VideoUtils {
    ...
    public static void main(String[] args) {
        ...
        convertMp4(inputStr, outStr, FfmpegResolutionEnum.RESOLUTION_1080P);
    ...
    public static void generateAllM3u8(String sourceFilePath) {
        ...
        if (width >= 1920) {
            convertMp4(sourceFilePath, folder1080p, FfmpegResolutionEnum.RESOLUTION_1080P);
            generateM3u8(folder1080p + File.separator + sourceFileName, folder1080p + File.separator + "hls");
            convertMp4(sourceFilePath, folder720p, FfmpegResolutionEnum.RESOLUTION_720P);
            generateM3u8(folder720p + File.separator + sourceFileName, folder720p + File.separator + "hls");
            convertMp4(sourceFilePath, folder360p, FfmpegResolutionEnum.RESOLUTION_360P);
     ...
     * @return
     */
    public static File convertMp4(String videoPath, String outFolderPath, FfmpegResolutionEnum ffmpegResolutionEnum) {
        ...
        try {
            Encoder encoder = new Encoder();
            encoder.convertMp4(videoPath, output, ffmpegResolutionEnum);
            return target;
        } catch (Exception e) {
    ...
    public static boolean convertMp4(String videoPath, String outFolderPath) {
        convertMp4(videoPath, outFolderPath, FfmpegResolutionEnum.RESOLUTION_1080P);
        return true;
    }
