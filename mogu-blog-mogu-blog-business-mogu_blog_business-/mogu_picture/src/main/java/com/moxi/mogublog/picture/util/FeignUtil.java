...
//        }
    ...
    public SystemConfig getSystemConfig() {
        ...
        if (systemConfigMap == null) {
            ...
            //判断阿里OSS
            if (EOpenStatus.OPEN.equals(uploadAlioss) && (StringUtils.isEmpty(aliyunEndPoint) || StringUtils.isEmpty(aliossPictureBaseUrl) || StringUtils.isEmpty(aliyunAccessKey)
