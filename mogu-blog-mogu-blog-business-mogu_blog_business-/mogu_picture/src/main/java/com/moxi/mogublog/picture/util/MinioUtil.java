...
public class MinioUtil {
     ...
     * @throws Exception
     */
    public String uploadFile(SystemConfig systemConfig, MultipartFile file) {
    ...
    public String uploadFile(SystemConfig systemConfig, File tempFile, String newFileName) {
     ...
     * @throws Exception
     */
    public String batchUploadFile(SystemConfig systemConfig, List<MultipartFile> list) {
     ...
     * @return
     */
    public String deleteFile(SystemConfig systemConfig, String fileName) {
        try {
     ...
     * @return
     */
    private String uploadSingleFile(SystemConfig systemConfig, MultipartFile multipartFile,String newFileName) {
        String url = "";
        try {
