<template>
	<view class="template-set">
		...
		<view class="tn-margin-top" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
			...
			<view class="tn-flex tn-flex-row-between tn-strip-bottom-min tn-padding" @click="tn('/pages/mine/bind')">
				<view class="justify-content-item">
					<view class="tn-text-bold tn-text-lg">
						账号绑定
					</view>
			...
			<view class="tn-flex  tn-footerfixed">
				<view class="tn-flex-1 justify-content-item tn-margin-sm tn-text-center" @click="logout">
