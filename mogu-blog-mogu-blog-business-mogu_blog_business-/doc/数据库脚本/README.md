...
- mogu_blog_business.sql：代表mogu_blog_business数据库的文件
...
- mogu_wechat.sql：代表 mogu_wechat 数据库文件，用于微信公众号相关

## 注意

- **首次导入数据库**文件的时候，我们**只需要执行`mogu_blog_business.sql` 、 `mogu_picture.sql`、 `mogu_wechat.sql`、`nacos_config.sql`**即可！！
