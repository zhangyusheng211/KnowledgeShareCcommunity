...
public class SystemConfig extends SuperEntity<SystemConfig> {
    ...
    /**
     * 阿里云Bucket 名称  ALIYUN_BUCKET_NAME("aliyunBucketName"),
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String aliyunBucketName;
    /**
     * 阿里云地域节点（EndPoint）ALIYUN_ENDPOINT("aliyunEndpoint"),
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String aliyunEndpoint;

    /**
     * 阿里云Access KeyALIYUN_ACCESS_KEY("aliyunAccessKey"),
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String aliyunAccessKey;
    /**
     * 阿里云Access Key Secret  ALIYUN_ACCESS_KEY_SECRET("aliyunAccessKeySecret"),
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    ...
    /**
     * 图片是否上传阿里云oss (0:否， 1：是)
     */
    private String uploadAlioss;
    ...
    /**
     * 阿里服务器文件域名前缀： http://minio.moguit.cn
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String aliossPictureBaseUrl;
