...
export function recorderBehavior(params) {
  return request({
    url: process.env.WEB_API + '/index/recorderBehavior',
    method: 'post',
    data: params
  })
}
...
export function getUserTopN(params) {
  return request({
    url: process.env.WEB_API + '/index/getUserTopN',
    method: 'post',
    data: params
  })
}

export function getVersionParams(params) {
  return request({
    url: process.env.WEB_API + '/index/getVersionParams',
    method: 'get',
    params
  })
}
