<template>
    <div class="sidebarDiv tuijian" v-if="hotBlogData.length > 0" style="border-radius: 3px; ">
      <h2 class="hometitle">点击排行</h2>
      <ul class="tjpic" v-if="hotBlogData[0]">

        <a :href="hotBlogData[0].type == 0 ? VUE_MOGU_WEB + '/info/'+hotBlogData[0].oid : hotBlogData[0].outsideLink" target="_blank">
          <i>
