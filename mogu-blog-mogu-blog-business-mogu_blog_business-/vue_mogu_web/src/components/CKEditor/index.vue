    ...
    initEditor() {
      ...
      CKEDITOR.replace('editor',
        {height: this.height,
          ...
          filebrowserImageUploadUrl: process.env.PICTURE_API + '/file/ckeditorUploadFile?token=' + getCookie("token"),
          filebrowserUploadUrl: process.env.PICTURE_API + '/file/ckeditorUploadFile?token=' + getCookie("token"),
          pasteUploadFileApi: process.env.PICTURE_API + '/file/ckeditorUploadCopyFile?token=' + getCookie("token"),
