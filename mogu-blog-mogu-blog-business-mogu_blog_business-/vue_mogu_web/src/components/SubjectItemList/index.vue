  ...
  <el-drawer
    ...
    <div class="block" style="  margin:10px;">
      ...
      <div v-if="!loading" style="text-align: center">
        <el-tag type="info">{{subject.subjectName}}</el-tag>
      </div>

      <el-empty description="空空如也" v-if="!loading && subjectItemlist.length == 0" :image-size="200"></el-empty>
      ...
      <el-timeline>
        <div class="blogsbox">
          <div
            ...
            style="padding: 8px"
          >
            <el-timeline-item :timestamp="item.blog.createTime" placement="top" style="padding-bottom: 0px">
              <el-card>

                <el-row>
                  <el-col  :span="19" :xs="24">
                    <a :href="item.blog.type == 0 ? VUE_MOGU_WEB + '/info/'+item.blog.oid : item.blog.outsideLink" target="_blank">
                      <p class="blogtext" v-html="item.blog.title, options">{{item.summary}}</p>
                    </a>
                  </el-col>
  ...
  import {getSubjectItemList} from "../../api/subject";
    export default {
      ...
      methods: {
        getList() {
          let params = {};
          params.subjectUid = this.subject.uid;
